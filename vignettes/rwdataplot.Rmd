...
```{r}
library(RWDataPlot)
rdf <- read.rdf(system.file('extdata/Scenario/DNF,2007Dems,IG/KeySlots.rdf',package = 'RWDataPlot'))
listSlots(rdf)
...
scenFolders <- c('DNF,2007Dems,IG/','VIC,2007Dems,IG/') # two scenario folders that exist in scenPath
scenNames <- c('Observed','Climate Change') # scenarios names
